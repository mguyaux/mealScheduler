...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Recipe}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Recipe> partialUpdateRecipe(
        ...
        Optional<Recipe> result = recipeRepository
            ...
            .map(existingRecipe -> {
                ...
                if (recipe.getNbOfPerson() != null) {
                    existingRecipe.setNbOfPerson(recipe.getNbOfPerson());
                }
                if (recipe.getPublicAccess() != null) {
                    existingRecipe.setPublicAccess(recipe.getPublicAccess());
                }
