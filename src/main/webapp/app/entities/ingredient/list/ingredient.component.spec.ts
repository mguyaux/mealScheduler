...
describe('Ingredient Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ingredient', component: IngredientComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to ingredientService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getIngredientIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getIngredientIdentifier).toHaveBeenCalledWith(entity);
