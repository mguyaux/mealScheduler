...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../schedule.test-samples';

import { ScheduleService, RestSchedule } from './schedule.service';
