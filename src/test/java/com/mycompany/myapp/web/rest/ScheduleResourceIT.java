...
class ScheduleResourceIT {
    ...
    private static final Meal DEFAULT_MEAL = Meal.BREAKFAST;
    private static final Meal UPDATED_MEAL = Meal.LUNCH;
    ...
    public static Schedule createEntity(EntityManager em) {
        Schedule schedule = new Schedule().meal(DEFAULT_MEAL).date(DEFAULT_DATE);
        return schedule;
    }
    ...
    public static Schedule createUpdatedEntity(EntityManager em) {
        Schedule schedule = new Schedule().meal(UPDATED_MEAL).date(UPDATED_DATE);
        return schedule;
    }
    ...
    void createSchedule() throws Exception {
        ...
        assertThat(testSchedule.getMeal()).isEqualTo(DEFAULT_MEAL);
    ...
    @Test
    @Transactional
    void checkMealIsRequired() throws Exception {
        int databaseSizeBeforeTest = scheduleRepository.findAll().size();
        // set the field null
        schedule.setMeal(null);
    ...
    void getAllSchedules() throws Exception {
        ...
        restScheduleMockMvc
            ...
            .andExpect(jsonPath("$.[*].meal").value(hasItem(DEFAULT_MEAL.toString())))
    ...
    void getSchedule() throws Exception {
        ...
        restScheduleMockMvc
            ...
            .andExpect(jsonPath("$.meal").value(DEFAULT_MEAL.toString()))
    ...
    void putExistingSchedule() throws Exception {
        ...
        updatedSchedule.meal(UPDATED_MEAL).date(UPDATED_DATE);
        ...
        Schedule testSchedule = scheduleList.get(scheduleList.size() - 1);
        assertThat(testSchedule.getMeal()).isEqualTo(UPDATED_MEAL);
    ...
    void partialUpdateScheduleWithPatch() throws Exception {
        ...
        partialUpdatedSchedule.meal(UPDATED_MEAL);
    ...
    void fullUpdateScheduleWithPatch() throws Exception {
        ...
        partialUpdatedSchedule.meal(UPDATED_MEAL).date(UPDATED_DATE);
