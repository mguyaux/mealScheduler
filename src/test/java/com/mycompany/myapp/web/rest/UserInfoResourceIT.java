...
class UserInfoResourceIT {
    ...
    private static final Integer DEFAULT_NB_OF_PERSON = 1;
    private static final Integer UPDATED_NB_OF_PERSON = 2;
    ...
    public static UserInfo createEntity(EntityManager em) {
        UserInfo userInfo = new UserInfo().nbOfPerson(DEFAULT_NB_OF_PERSON);
        return userInfo;
    }
    ...
    public static UserInfo createUpdatedEntity(EntityManager em) {
        UserInfo userInfo = new UserInfo().nbOfPerson(UPDATED_NB_OF_PERSON);
        return userInfo;
    }
    ...
    void createUserInfo() throws Exception {
        ...
        assertThat(testUserInfo.getNbOfPerson()).isEqualTo(DEFAULT_NB_OF_PERSON);
    }
    ...
    void putExistingUserInfo() throws Exception {
        ...
        updatedUserInfo.nbOfPerson(UPDATED_NB_OF_PERSON);
        ...
        UserInfo testUserInfo = userInfoList.get(userInfoList.size() - 1);
        assertThat(testUserInfo.getNbOfPerson()).isEqualTo(UPDATED_NB_OF_PERSON);
    }
    ...
    void fullUpdateUserInfoWithPatch() throws Exception {
        ...
        partialUpdatedUserInfo.nbOfPerson(UPDATED_NB_OF_PERSON);
